...
const faqItems: FAQItem[] = [
    ...
    },
    {
        ...
        answer: "MATRIX Precision Machines は1913年に英国で創業し、現在は台湾に生産拠点を置く歯車研削盤の専門メーカーです。成形研削盤・創成研削盤・ウォーム研削盤・ベベルギア研削盤など幅広い製品を展開しています。清水商會は特定メーカーに偏らない中立的な立場を基本としておりますが、歯車研削の分野においてはMATRIX製品の導入相談・据付・アフターサービスに対応しております。",
    },
    {
        question: "中古機械の買取・販売は行っていますか？",
        answer: "はい。中古の歯車工作機械や研削盤の買取・整備・販売を行っております。創業以来培った確かな目利きにより、適正な査定と丁寧な整備を実施し、次のお客様へお届けしています。2013年にはツルミマシンセンターを開設し、中古機械の展示・整備体制を強化しました。売りたい・買いたい、どちらもお気軽にご相談ください。",
    },
    {
